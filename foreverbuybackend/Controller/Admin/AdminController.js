...
const AdminRegister=async (req,res)=>{
    try{
           ...
           if(!AdminUserName || !Email || !Password){
...
const Login=async(req,res)=>{
    try{
          ...
          const token=jsonweb.sign({id:IsEmailAvail._id,AdminUserName:IsEmailAvail.AdminUserName,Email:IsEmailAvail.Email},process.env.SECRETKEY,{expiresIn:'1h'});
